...
$SecondStorageAccountFqdn = "**************".blob.core.chinacloudapi.cn"

$DefaultStorageAccountKey = Get-AzureStorageKey $DefaultStorageAccountName | %{ $_.Primary }
$SecondStorageAccountKey1 = Get-AzureStorageKey $SecondStorageAccountName | %{ $_.Primary }
...
New-AzureHDInsightClusterConfig -ClusterType Hadoop -ClusterSizeInNodes $DataNodesNumber -HeadNodeVMSize $HeadNodeVMSize -DataNodeVMSize $DataNodeVMSize  |
    ...
    Add-AzureHDInsightStorage -StorageAccountName $SecondStorageAccountFqdn -StorageAccountKey $SecondStorageAccountKey |
